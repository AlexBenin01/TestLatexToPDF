...
\newcommand{\data}{20 Dicembre 2024}
\newcommand{\titolo}{Verbale Esterno}
\newcommand{\responsabile}{Alessandro Benin}
\newcommand{\verificatore}{Tommaso Zocche}
\newcommand{\redattore}{Alessandro Benin}
\newcommand{\uso}{Esterno}
\newcommand{\destinatari }{
    & Vimar S.p.A.  \\
    & Tullio Vardanega  \\
    & Riccardo Cardin  }
\newcommand{\abstractcontent}{Terza riunione SAL del gruppo con Vimar S.p.A. sono stati riportati i progressi e i dubbi riscontrati nelle due settimane, sono stati forniti consigli e chiarimenti sulle tecnologie e i prossimi obiettivi da raggiungere}

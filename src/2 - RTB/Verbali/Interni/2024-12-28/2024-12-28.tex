...
\newcommand{\data}{22 dicembre 2024}
...
\newcommand{\destinatari }{
   %& Vimar S.p.A.  \\
    & Tullio Vardanega  \\
    & Riccardo Cardin  }
\newcommand{\abstractcontent}{Riunione in concomitanza alla fine del terzo sprint: sono stati stabiliti i ruoli per il prossimo periodo e sono state discusse le difficoltà incontrate dall'ultima riunione interna}
